...
EXTERN int 
ayemu_set_chip_type(ayemu_chip_t chip, int *custom_table);

EXTERN void
ayemu_set_chip_freq(int chipfreq);

EXTERN int
ayemu_set_stereo(ayemu_stereo_t stereo, int *custom_eq);

EXTERN int
ayemu_set_sound_format(int freq, int chans, int bits);

EXTERN void 
ayemu_set_regs(ayemu_ay_reg_frame_t regs);

EXTERN void*
ayemu_gen_sound(void *buf, size_t bufsize);
